...
-->
<form action="http://oauthserver.com/oauth/authorize/response_type=code&client_id=<?= $config['client_id']?>&redirect_uri=https://client-ul.com/callback.php" method="POST">
